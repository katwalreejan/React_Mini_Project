                  ...
                  <div className="row pt-lg-5">
                    <div className="col-lg-6 col-12">
                      <div className="services-thumb">
                        ...
                        <p>
                          You may want to explore Too CSS for great collection
                          of free HTML CSS templates.
                        </p>
                    ...
                    <div className="col-lg-6 col-12">
                      <div className="services-thumb services-thumb-up">
                        ...
                        <p>
                          You can explore more CSS templates on TemplateMo
                          website by browsing through different tags.
                        </p>
                    ...
                    <div className="col-lg-6 col-12">
                      <div className="services-thumb services-thumb-up">
                        ...
                        <p>
                          To list your website first on any search engine, we
                          will work together. First Portfolio is one-page CSS
                          Template for free download.
                        </p>
              ...
              <div className="row">
                ...
                <div className="col-lg-3 col-md-6 col-12 ps-lg-0">
                  <div className="contact-info d-flex flex-column">
                    ...
                    <p className="mb-2">
                      Joshua is a professional web developer. Feel free to get
                      in touch with me.
                    </p>
